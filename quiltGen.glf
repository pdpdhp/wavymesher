...
proc MDL_GEN { flatback } {
	...
	global span nxnodes nynodes airfoil_mdl nprofile FLTB_Crvs0 TE_thk
	...
	if {[string compare $flt YES]==0} {
		...
		puts "FLATBACK COORDINATES ($fltpercent % OF CHORD) ARE GENERATED BY $fltmethod."
		puts $asep
	...
	set TE_thk [expr abs([lindex [[lindex $FLTB_Crvs0 0] getXYZ -arc 1] 1] - \
					[lindex [[lindex $FLTB_Crvs0 1] getXYZ -arc 1] 1])/1000 ]
